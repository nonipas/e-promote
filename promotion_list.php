              ...
              <table class="table table-striped uppertext" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <?php 
                            ...
                            $sql = "SELECT *,(`emp_promotion`.`id`) As promo_id, (`emp_promotion`.`emp_id`) As p_emp_id, (`emp_salary_grade`.`id`) As new_grade_id
                            FROM `emp_promotion` 
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a target="_blank" href="emp_promotion_print.php?promotion_id=<?php echo $row['promo_id']; ?>" class="text-primary"><i class="fa fa-eye"></i></a></td>
